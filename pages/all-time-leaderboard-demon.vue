<script setup>
import { ALL_DEMON } from "@/composables/useSheet";
...
<template>
  <title>MyGMDI - All-Time Leaderboard - Demon</title>
  ...
  <div class="w-full h-full bg-background-950 px-2 xl:px-72 py-16">
    ...
    <div class="my-2 mb-10">
      <h2 class="text-5xl text-primary-300 underline font-bold">
        All-Time Leaderboard - Demon
      </h2>
      <p class="text-primary-100 text-xl my-2">
        Top 50 players with the most Demons
      </p>
    </div>
      ...
      <table class="table table-lg">
        ...
        <tbody class="">
          ...
          >
            ...
            >
              {{ col[3] }} <img class="size-6" src="../assets/img/demon.png" />
            </td>
          </tr>
        </tbody>
      </table>
