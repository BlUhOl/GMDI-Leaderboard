<script setup>
import { ref } from "vue";
import { MONTHLY_UC, MONTHLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await MONTHLY_UC();
const version = await MONTHLY_VERSION();
...
<template>
  <title>Monthly Leaderboard - User Coin</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Monthly Leaderboard - User Coin</li>
      </ul>
    </div>
    ...
    <div class="my-2 mb-5">
      ...
      >
        User Coin
        <img class="size-10" src="https://www.dropbox.com/scl/fi/8ry1a04thr00ddw0ohg8n/silvercoin.png?rlkey=zgkvupj1hqwvnxjhd67uo8lwj&dl=1" />
      </h2>
      <p class="text-primary-100 text-xl my-2">
        Top 25 players with the most User Coins Monthly
      </p>
      <br />
      ...
      <table class="table table-xs md:table-md lg:table-lg">
        ...
        >
          <tr>
            ...
            <th class="text-center w-min">Jumlah User Coin</th>
          </tr>
        </thead>
        <tbody class="">
          <tr
          ...
          >
            ...
            >
              +{{col[2]}}
              <img class="size-4 md:size-6" src="https://www.dropbox.com/scl/fi/8ry1a04thr00ddw0ohg8n/silvercoin.png?rlkey=zgkvupj1hqwvnxjhd67uo8lwj&dl=1" />
            </td>
          </tr>
        </tbody>
      </table>
