<script setup>
import { ref } from "vue";
import { MONTHLY_DIAMOND, MONTHLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await MONTHLY_DIAMOND();
...
<template>
  <title>Monthly Leaderboard - Diamond</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Monthly Leaderboard - Diamond</li>
      </ul>
    </div>
    ...
    <div class="my-2 mb-5">
      ...
      <p class="text-primary-100 text-xl my-2">
        Top 25 players with the most Diamonds Monthly
      </p>
      <br />
