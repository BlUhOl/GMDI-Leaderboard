<script setup>
import { ref } from "vue";
import { WEEKLY_UC, WEEKLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await WEEKLY_UC();
...
<template>
  <title>Weekly Leaderboard - User Coin</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Weekly Leaderboard - User Coin</li>
      </ul>
    </div>
    ...
    <div class="my-2 mb-5">
      ...
      <p class="text-primary-100 text-xl my-2">
        Top players with the most User Coins weekly
      </p>
      <br />
          ...
          >
            ...
            >
              ...
              <img
                ...
                src="https://www.dropbox.com/scl/fi/8ry1a04thr00ddw0ohg8n/silvercoin.png?rlkey=zgkvupj1hqwvnxjhd67uo8lwj&dl=1"
              />
            </td>
          </tr>
        </tbody>
