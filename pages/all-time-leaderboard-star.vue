<script setup>
import { ref } from "vue";
import { ALL_STAR, ALLTIME_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await ALL_STAR();
...
<template>
  <title>All-Time Leaderboard - Star</title>
  ...
  <div class="w-full h-full bg-gradient-to-b from-background-900 to-background-950/50 px-2 lg:px-52 xl:px-72 py-16 bg-blend-color">
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">All-Time Leaderboard - Star </li>
      </ul>
    </div>
    ...
    <div class="my-2 mb-5">
      ...
      <p class="text-primary-100 text-xl my-2">
        Top 25 players with the most Stars all time
      </p>
      <br/>
