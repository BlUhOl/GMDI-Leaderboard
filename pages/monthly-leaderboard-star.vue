<script setup>
import { ref } from "vue";
import { MONTHLY_STAR, MONTHLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await MONTHLY_STAR();
...
<template>
  <title>Monthly Leaderboard - Star</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Monthly Leaderboard - Star</li>
      </ul>
    </div>
    ...
    <div class="my-2 mb-5">
      ...
      >
        Star
        <img class="size-10" src="https://www.dropbox.com/scl/fi/haeqlpvkg2b1wpk7nwj3u/star.png?rlkey=j6fiwsc36p9545xs6seqxs0v7&dl=1"/>
      </h2>
      <p class="text-primary-100 text-xl my-2">
        Top 25 players with the most Stars monthly
      </p>
      <br />
      ...
      <table class="table table-xs md:table-md lg:table-lg">
        ...
        <tbody class="">
          ...
          >
            ...
            >
              +{{col[2]}}
              <img class="size-4 md:size-6" src="https://www.dropbox.com/scl/fi/haeqlpvkg2b1wpk7nwj3u/star.png?rlkey=j6fiwsc36p9545xs6seqxs0v7&dl=1" />
            </td>
          </tr>
        </tbody>
      </table>
