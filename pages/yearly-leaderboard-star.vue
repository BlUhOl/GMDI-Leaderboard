<script setup>
import { ref } from "vue";
import { YEARLY_STAR, YEARLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await YEARLY_STAR();
...
<template>
  <title>Yearly Leaderboard - Star</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Yearly Leaderboard - Star</li>
      </ul>
    </div>
