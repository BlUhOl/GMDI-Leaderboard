<script setup>
import { ref } from "vue";
import { YEARLY_MOON, YEARLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await YEARLY_MOON();
...
<template>
  <title>Yearly Leaderboard - Moon</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Yearly Leaderboard - Moon</li>
      </ul>
    </div>
    ...
    <div class="my-2 mb-5">
      ...
      <p class="text-primary-100 text-xl my-2">
        Top 25 players with the most Moons yearly
      </p>
      <br />
