<script setup>
import { ref } from "vue";
import { WEEKLY_MOON, WEEKLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await WEEKLY_MOON();
...
<template>
  <title>Weekly Leaderboard - Moon</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Weekly Leaderboard - Moon</li>
      </ul>
    </div>
