<script setup>
import { ref } from "vue";
import { MONTHLY_DEMON, MONTHLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await MONTHLY_DEMON();
...
<template>
  <title>Monthly Leaderboard - Demon</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Monthly Leaderboard - Demon</li>
      </ul>
    </div>
    ...
    <div class="my-2 mb-5">
      ...
      >
        Demon
        <img class="size-10" src="https://www.dropbox.com/scl/fi/tx79o6y04uph7spyz3rkd/demon.png?rlkey=hjtyc0tqzg28ypdpjd6z2czkk&dl=1" />
      </h2>
      <p class="text-primary-100 text-xl my-2">
        Top 25 players with the most Demons Monthly
      </p>
      <br />
      ...
      <table class="table table-xs md:table-md lg:table-lg">
        ...
        >
          <tr>
            ...
            <th class="text-center w-min">Jumlah Demon</th>
          </tr>
        </thead>
        <tbody class="">
          <tr
          ...
          >
            ...
            >
              +{{col[2]}}
              <img class="size-4 md:size-6" src="https://www.dropbox.com/scl/fi/tx79o6y04uph7spyz3rkd/demon.png?rlkey=hjtyc0tqzg28ypdpjd6z2czkk&dl=1" />
            </td>
          </tr>
        </tbody>
      </table>
