<script setup>
import { ref } from "vue";
import { MONTHLY_MOON, MONTHLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await MONTHLY_MOON();
...
<template>
  <title>Monthly Leaderboard - Moon</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Monthly Leaderboard - Moon</li>
      </ul>
    </div>
    ...
    <div class="my-2 mb-5">
      ...
      <p class="text-primary-100 text-xl my-2">
        Top 25 players with the most Moons monthly
      </p>
      <br />
      ...
      <table class="table table-xs md:table-md lg:table-lg">
        ...
        >
          <tr>
            ...
            <th class="text-center w-min">Jumlah Moon</th>
          </tr>
        </thead>
        <tbody class="">
          <tr
