<script setup>
import { ref } from "vue";
import { WEEKLY_DIAMOND, WEEKLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await WEEKLY_DIAMOND();
...
<template>
  <title>Weekly Leaderboard - Diamond</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Weekly Leaderboard - Diamond</li>
      </ul>
    </div>
