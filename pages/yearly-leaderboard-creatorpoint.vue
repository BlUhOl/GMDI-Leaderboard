<script setup>
import { ref } from "vue";
import { YEARLY_CP, YEARLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await YEARLY_CP();
...
<template>
  <title>Yearly Leaderboard - Creator Point</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Yearly Leaderboard - Creator Point</li>
      </ul>
    </div>
    ...
    <div class="my-2 mb-5">
      ...
      <p class="text-primary-100 text-xl my-2">
        Top 35 players with the most Creator Points Yearly
      </p>
      <br />
