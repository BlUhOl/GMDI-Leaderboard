<script setup>
import { ref } from "vue";
import { WEEKLY_STAR, WEEKLY_VERSION } from "@/composables/useSheet";

const result = ref([]);
const { data } = await WEEKLY_STAR();
...
<template>
  <title>Weekly Leaderboard - Star</title>
  ...
  >
    <div class="text-sm text-primary-600 breadcrumbs">
      <ul>
        ...
        <li class="cursor-default">Weekly Leaderboard - Star</li>
      </ul>
    </div>
    ...
    <div class="my-2 mb-5">
      ...
      <p class="text-primary-100 text-xl my-2">
        Top players with the most Stars weekly
      </p>
      <br />
