<script setup>
import { ALL_UC } from "@/composables/useSheet";
  ...
  <div class="w-full h-full bg-background-950 px-2 xl:px-72 py-16">
    ...
    <div class="my-2 mb-10">
      <h2 class="text-5xl text-primary-300 underline font-bold">
        All-Time Leaderboard - User Coin
      </h2>
      <p class="text-primary-100 text-xl my-2">
        Top 50 players with the most User Coins
      </p>
    </div>

    <div class="overflow-x-auto">
      <table class="text-sm md:text-xl md:table-lg">
        ...
        <tbody class="">
          ...
          >
            ...
            >
              {{ col[3] }} <img class="size-4 md:size-6" src="../assets/img/silvercoin.png" />
            </td>
          </tr>
        </tbody>
      </table>
